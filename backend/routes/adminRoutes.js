...
const { getAllUserDetails, getUserDetails, getUserLoanInquiries, getLoanInquiryDetails, createProxyUser, checkVerficationDetails, getLoanDocumentDetails, getLoanDocumentLink, setLoanDocumentVerify, setLoanStatus, setDocumentStatus, getLoanDetailsForSanction, updateLoanSanctionLetterDetails, getLoanSanctionLetterDetails, getLoanTypeCount } = require('../Controller/adminController');
...
router.get('/getUser/loan/details/count', authMiddleware,isAdmin, getLoanTypeCount)
...
router.post('/getUser/loan/details/saction/update/:userId/:email/:loanId', updateLoanSanctionLetterDetails)
router.get('/getUser/loan/details/saction/letter/details/:userId/:email/:loanId', getLoanSanctionLetterDetails)
