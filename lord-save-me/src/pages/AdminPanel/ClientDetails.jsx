        ...
        const timeout = setTimeout(() => {
			setColumns([
				...
				},
				{
				    ...
				    selector: (row) => row.loan_status === 'Pending' ? <MDBBadge pill color='danger' light>{row.loan_status}</MDBBadge> : <MDBBadge pill color='success' light>{row.loan_status}</MDBBadge>,
				    sortable: true,
				},
			]);
			setPending(false);
